...
или отобразить на экране. Очевидно, очень важной функцией \makefile{а}
...
замечательная небольшая программа, \utility{xsltproc}, и
вспомогательный сценарий, \utility{xmlto}, которые я использовал для
...
отфильтровываются, после чего последний раз вызывается \utility{egrep}
